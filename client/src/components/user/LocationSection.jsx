...
export default function LocationSection() {
  ...
  const [isFireBrigadeBookedClicked, setIsFireBrigadeBookedClicked] =
    useState("Book Now");
    ...
    if (socket) {
      socket.on("ambulanceLocation", (data) => {
        ...
        setAmbulanceList((prevList) => {
          if (
            !prevList.some(
              (ambulance) => ambulance.vehicleNumber === data.user.vehicleNumber
            )
          ) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium">
                    Ambulance No: {ambulance.vehicleNumber}
                  </div>
          ...
          fireBrigadeList.map((items, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium">
                    Fire Brigade No: {items.vehicleNumber}
                  </div>
